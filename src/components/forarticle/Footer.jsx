...
const Footer = () => {
  ...
  const translations = {
    ...
    darkMode: "Dark Mode",
    copyright: "© 2025 ICT Laws Hub. All rights reserved.",
  };
  ...
  return (
    <footer id="footer" className={`footer ${darkMode ? "dark" : ""}`}>
        ...
        <div className="footer-content">
          ...
          <div className="footer-links">
            <div className="footer-links-column">
              <h3 className="footer-links-title">{translations.usefulLinks}</h3>
              <ul className="footer-links-list">
                ...
                <li>
                  <a href="#explore">{translations.explore}</a>
                </li>
                <li>
            ...
            <div className="footer-links-column">
              <h3 className="footer-links-title">{translations.contactUs}</h3>
              <ul className="footer-links-list">
                <li>
                  <a href="#">info@ictlawshub.com</a>
                </li>
                <li>
