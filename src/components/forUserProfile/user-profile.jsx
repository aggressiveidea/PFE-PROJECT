...
//           </div>
//           {article.click > 25 && (
//             <div className="up_article-trending">Trending</div>
//           )}
//         </div>

//         <h3 className="up_article-title">{article.title}</h3>

//         <div className="up_article-author">
//           <div className="up_author-avatar">
//             <img
//               src={user.profileImgUrl || "/placeholder.svg?height=40&width=40"}
...
//             />
//           </div>
//           <div className="up_author-info">
//             <span className="up_author-name">{`${user.firstName} ${user.lastName}`}</span>
//             <span className="up_article-date">
